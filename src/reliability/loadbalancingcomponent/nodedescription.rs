...
impl NodeDescription {
    ...
    pub fn new(node_instance: NodeInstance, is_up: bool, deactivation_intent: NodeDeactivationIntent, deactivation_status: NodeDeactivationStatus, node_properties: HashMap<String, String>, fault_domain_id: DomainId, upgrade_domain_id: String, capacity_ratios: HashMap<String, u32>, capacities: HashMap<String, u32>, is_pending_close: bool, is_replica_uploaded: bool) -> NodeDescription{
        NodeDescription{
            node_instance: node_instance,
            is_up: is_up,
            deactivation_intent: deactivation_intent,
            deactivation_status: deactivation_status,
            node_properties: node_properties,
            fault_domain_id: fault_domain_id,
            upgrade_domain_id: upgrade_domain_id,
            capacity_ratios: capacity_ratios,
            capacities: capacities,
            is_pending_close: is_pending_close,
            is_replica_uploaded: is_replica_uploaded,
        }
    }
}